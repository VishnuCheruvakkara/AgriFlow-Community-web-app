      ...
      dark:bg-zinc-950 dark:text-zinc-100 dark:placeholder-zinc-500 dark:border-zinc-700"
                    ...
                    {loading ? (
                        ...
                        filteredEvents.length > 0 ? (
                                    ...
                                    <div className="flex-1 flex flex-col gap-1">
                                            ...
                                            <div className="flex gap-2 flex-shrink-0">
                                                <span
                                                    className={`text-xs px-2 py-1 rounded-full font-medium ${event.event_status === "upcoming"
                                                        ? "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300 border border-green-700 "
                                                        : event.event_status === "completed"
                                                            ? "bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300 border border-gray-700 "
                                                            : "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300 border border-red-700"
                                                        }`}
                                                >
                                                ...
                                                <span
                                                    className={`text-xs px-2 py-1 rounded-full font-medium ${event.event_type === "online"
                                                        ? "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 border border-blue-700"
                                                        : "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300 border border-yellow-700"
                                                        }`}
                                                >
                                                    {event.event_type
                                        ...
                                        <div className="flex flex-wrap items-center gap-1 text-xs text-gray-500 dark:text-zinc-500">
                                            ...
                                            <div className="flex items-center gap-1">
                                                <span className="w-1 h-1 bg-green-500 rounded-full"></span>
                                                <span>
                                                    Location: {event.location_name || event.address || "Not specified"}
                                                </span>
                                            </div>
                                            {event.country && (
                                                <div className="flex items-center gap-1">
                            ...
                            <div className="col-span-3 h-[360px] text-center border-2 border-dashed border-gray-300 text-gray-600 pt-14 px-4 bg-gray-100 rounded-md dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-300 ">
                                <img
                                    src={SearchNotFound}
                                    alt="No Events"
