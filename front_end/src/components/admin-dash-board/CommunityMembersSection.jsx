    ...
    return (
        <div className="bg-zinc-50 dark:bg-zinc-700 rounded-lg shadow-sm border border-green-400">
            ...
            <div className="px-2 mt-2 flex flex-col md:flex-row md:items-center gap-2">
                <div className="flex items-center flex-1 border border-zinc-300 focus-within:border-green-500 dark:focus-within:border-green-500 dark:border-zinc-700 bg-white dark:bg-zinc-800 rounded-lg shadow-sm px-3 py-1 transition duration-300 ease-in-out">
                    {/* Search Icon */}
                ...
                <div className="relative w-full md:w-auto">
                    <select
                        ...
                        className="w-full appearance-none border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-sm rounded-lg px-3 py-[10px] pr-10 text-gray-700 dark:text-zinc-200 focus:border-green-400  dark:focus:border-green-400  transition duration-300 ease-in-out"
                    >
                    ...
                    {/* Custom Down Arrow */}
                    <IoChevronDown
                        className="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none text-gray-500 dark:text-zinc-300 text-lg"
                    />
                </div>
