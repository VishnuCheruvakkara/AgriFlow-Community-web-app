        ...
        <div className="fixed inset-0 z-[9999]">
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
                <motion.div
                    ...
                    className="bg-white dark:bg-zinc-800 w-full max-w-4xl rounded-lg shadow-xl overflow-hidden"
                >
                    {/* Header */}
                        ...
                        >
                            {({ isSubmitting, values, errors, touched, setFieldValue, setFieldTouched, setFieldError, submitForm }) => (
                                <>
                                    ...
                                    {/* Footer Buttons - Moved inside Formik render prop */}
                                    <div className="bg-gray-100 dark:bg-zinc-700 px-6 py-3 flex justify-end gap-3 border-t border-gray-200 dark:border-zinc-600 mt-6 -mx-6 -mb-6">
                                        <button
                                            type="button"
