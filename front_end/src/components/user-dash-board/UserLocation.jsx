...
const UserLocation = ({ formData, setFormData, errors, fieldErrors,defaultQuery }) => {
    ...
    <div className="relative">
        ...
        <input
            ...
            onBlur={handleBlur}
            className={`bg-white text-black dark:bg-zinc-900 dark:text-white w-full pl-10 px-4 py-3 border border-gray-300 dark:border-zinc-600 rounded-lg focus:outline-none focus:ring-2 ${
                localError || errors || noDataFound
                    ? "ring-2 ring-red-500"
