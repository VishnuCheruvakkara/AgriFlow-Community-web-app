                    ...
                    <div className="space-y-3">
                        {requests.length === 0 ? (
                            <div className="text-center border-2 border-dashed border-gray-300 dark:border-zinc-600 text-gray-600 dark:text-gray-300 py-5 px-4 bg-gray-100 dark:bg-zinc-800 rounded-md">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400">Requests from other users will appear here.</p>
                            </div>
                        ) : (
                            requests.map((request) => (
                                ...
                                >
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-gray-800 dark:text-gray-100">{request.sender_username}</h3>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => rejectRequest(request.id, request.sender_username)} className="px-3 py-2 bg-gray-300 dark:bg-zinc-600 text-gray-700 dark:text-gray-200 rounded-md text-sm hover:bg-gray-500 dark:hover:bg-zinc-500 hover:text-white transition">
                                            Reject
                                        </button>
                                    </div>
                                </div>
