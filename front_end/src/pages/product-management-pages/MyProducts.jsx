...
function MyProducts() {
    ...
    //handle the product details section 
                                    ...
                                    products.map((product, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="mt-4 flex gap-2">
                                                <button onClick={() => handleOpenProductDetails(product)} className="flex-1 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition duration-300 flex items-center justify-center gap-2 dark:bg-green-600 dark:hover:bg-green-700">
                                                    <FaEye size={16} /> View
                                                </button>
                                            </div>
                                        </div>
