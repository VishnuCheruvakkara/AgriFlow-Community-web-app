...
function MyProducts() {
    ...
    const handleProductSave = (newProduct) => {
        console.log('New product added completed :', newProduct);
        showToast('New product added:', 'success')
        // Here you can update your products list or refresh data
        // For example: setProducts(prev => [...prev, newProduct]);
    };
                        ...
                        products.map((product, index) => (
                            ...
                            >
                                <div className="flex-1">
                                    ...
                                    {/* Category (You can add a category field if you have) */}
                                ...
                                <div className="mt-4 flex gap-2">
                                    <button className="flex-1 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition duration-300 flex items-center justify-center gap-2 dark:bg-green-600 dark:hover:bg-green-700">
                                        <FaEye size={16} /> View
                                    </button>
                                </div>
                            </div>
