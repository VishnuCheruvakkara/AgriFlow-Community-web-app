    ...
    return (
        <>
            ...
            <div className="breadcrumbs text-sm">
                <ul>
                    <li>
                        <Link to="/admin/users-management" className="text-green-500 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300">
                            Farmers Management
                        </Link>
                    </li>
                    <li>
                        <span className="text-gray-500 hover:text-gray-500 dark:text-zinc-400 dark:hover:text-zinc-400 no-underline hover:no-underline cursor-default">
                            Farmers Details
                        </span>
                    </li>
                </ul>
            ...
            <div className="max-w-full mx-auto bg-white dark:bg-zinc-800 shadow-xl rounded-lg overflow-hidden">
                ...
                <div className="flex items-center justify-between bg-gradient-to-r from-green-700 to-green-400 p-4 text-white rounded-t-md">
                    ...
                    <button
                        onClick={() => navigate(-1)}
                        className="border border-white hover:border-transparent text-white hover:bg-green-700 rounded-full p-1 transition-colors duration-300"
                        aria-label="Close"
                    >
                ...
                <div className="p-6">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6 pb-6 border-b border-gray-200 dark:border-zinc-600">
                        <div className="relative">
                            <img
                                ...
                                alt="Profile Picture"
                                className="w-32 h-32 rounded-full border-4 border-white dark:border-zinc-700 shadow-lg object-cover"
                            />

                            {user?.is_aadhar_verified &&
                                
                                <div className="absolute bottom-2 right-2 bg-green-500 text-white rounded-full p-1 tooltip tooltip-right" data-tip="Verified">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <div className="mt-2 space-y-2">
                                <div className="flex items-center justify-center md:justify-start text-gray-600 dark:text-zinc-300">
                                ...
                                <div className="flex items-center justify-center md:justify-start text-gray-600 dark:text-zinc-300">
                                    ...
                                    <span>
                                        ...
                                        {age !== null && (
                                            <span className="ml-4 text-gray-500 dark:text-zinc-400">({age} years old)</span>
                                        )}
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        {/* Address */}
                        <div className="bg-gray-50 dark:bg-zinc-700 rounded-lg p-4 shadow-md overflow-hidden">
                            <div className="flex items-center mb-3">
                                <FaMapMarkerAlt className="text-xl text-green-500 mr-2" />
                                <h3 className="text-lg font-semibold text-gray-700 dark:text-zinc-200">Address</h3>
                            </div>
                        ...
                        {/* Farming Details */}
                        <div className="bg-gray-50 dark:bg-zinc-700 rounded-lg p-4 shadow-md">
                            <div className="flex items-center mb-3">
                                <FaSeedling className="text-xl text-green-500 mr-2" />
                                <h3 className="text-lg font-semibold text-gray-700 dark:text-zinc-200">Farming Details</h3>
                            </div>
                            <div className="pl-7">
                                <div className="flex justify-between mb-1">
                                    <span className="text-gray-600 dark:text-zinc-300"><span className="text-green-500 font-bold">Farming Type :</span> {user && user?.farming_type || "No data found"}</span>
                                </div>
                                <div className="flex justify-between mb-1">
                                    <span className="text-gray-600 dark:text-zinc-300"><span className="text-green-500 font-bold">Year of Experience :</span> {user && user?.experience || "0"} years</span>
                                </div>
                                <div className="mt-2 pt-2 border-t border-gray-200 dark:border-zinc-600">
                                    ...
                                    <p className="text-gray-600 dark:text-zinc-300 text-sm italic break-words mt-2">
                        ...
                        {/* Verification Status */}
                        <div className="bg-gray-50 dark:bg-zinc-700 rounded-lg p-4 shadow-md md:col-span-2">
                            <div className="flex items-center mb-3">
                                <FaIdCard className="text-xl text-green-500 mr-2" />
                                <h3 className="text-lg font-semibold text-gray-700 dark:text-zinc-200">Verification Status</h3>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                {user?.profile_completed && (
                                    ...
                                    <div
                                        className="flex items-center justify-between p-2 bg-white dark:bg-zinc-800 rounded border border-gray-200 dark:border-zinc-600 cursor-pointer hover:bg-gray-100 dark:hover:bg-zinc-700"
                                        onClick={openAadharModal}
                                    >
                                        <div className="flex items-center">
                                            <span className="text-gray-600 dark:text-zinc-300">Aadhaar Verified</span>
            ...
            {showAadharModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-25 dark:bg-black dark:bg-opacity-50 overflow-hidden scrollbar-hide">
                    <motion.div
                        drag
                    ...
                    >
                        <div className="bg-white dark:bg-zinc-800 rounded-lg w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto shadow-lg scrollbar-hide relative">
                            ...
                            {/* Modal Header */}
                            <div className="border-b border-zinc-300 dark:border-zinc-600 px-4 py-3 flex items-center justify-between 
                        ...
                        sticky top-0 z-10 w-full rounded-t-lg">
                                ...
                                {user && user?.is_aadhar_verified ? (
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-white dark:bg-zinc-700 p-4 rounded-lg shadow-lg border border-gray-300 dark:border-zinc-600">
                                            ...
                                            {user?.aadhar_card ? (
                                                <div className="flex justify-center border-2 border-gray-300 dark:border-zinc-600 rounded-lg p-2 bg-gray-100 dark:bg-zinc-800">
                                                    <img
                                                ...
                                                <div className="w-full h-48 bg-gray-100 dark:bg-zinc-700 flex items-center justify-center border-2 border-gray-300 dark:border-zinc-600 rounded-lg">
                                        ...
                                        {/* Status Badge */}
                                        <div className="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-200 px-4 py-2 rounded-full inline-flex items-center">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {user?.aadhar_card && (
                                            <div className="bg-white dark:bg-zinc-700 p-4 rounded-lg shadow-lg border border-gray-300 dark:border-zinc-600">
                                                <h4 className="font-bold text-gray-700 dark:text-zinc-200 mb-4">Uploaded Aadhaar Image</h4>
                                                <div className="flex justify-center border-2 dark:border-zinc-600 mb-4">
                                                    <img
                                                        src={user.aadhar_card}
                                                        alt="Aadhaar"
                                        ...
                                        <div className="flex flex-col  gap-6">
                                            ...
                                            {!showInputField ? (
                                                <button
                                                    className="flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white px-4 py-3 rounded-md shadow-md"
                                                ...
                                                <div className="border border-gray-300 dark:border-zinc-600 rounded-md p-4 bg-white dark:bg-zinc-700 shadow-md">
                                                    <div className="mb-1">
                                                        <label className="block text-sm font-medium text-gray-700 dark:text-zinc-200 mb-2">
                                                            Reason for resubmission:
                                                        </label>
                                                        <textarea
                                                            className={`bg-white dark:bg-zinc-800 text-black dark:text-zinc-100 w-full px-4 py-3 border border-gray-300 dark:border-zinc-600 rounded-lg focus:outline-none focus:ring-2 ${messageError?.aadhar_resubmission_message ? " focus:ring-red-500" : "focus:ring-green-500"
                                                    ...
                                                    <div className="flex justify-end gap-3 mt-4">
                                                        <button
                                                            className="flex items-center gap-1 px-3 py-2 bg-gray-200 dark:bg-zinc-600 text-gray-800 dark:text-zinc-200 rounded-md hover:bg-gray-300 dark:hover:bg-zinc-500"
                                                        ...
                                                        <button
                                                            className="flex items-center gap-1 px-3 py-2 bg-red-500 dark:bg-red-600 text-white rounded-md hover:bg-red-600 dark:hover:bg-red-700 disabled:bg-red-300 dark:disabled:bg-red-400"
                            ...
                            <div className="border-t border-zinc-300 dark:border-zinc-600 px-4 py-3 flex justify-end bg-gray-50 dark:bg-zinc-700">
                                <button onClick={closeAadharModal} className="px-4 py-2 bg-gray-300 dark:bg-zinc-600 text-gray-700 dark:text-zinc-200 rounded hover:bg-gray-400 dark:hover:bg-zinc-500">
                                    Close
                                </button>
                            </div>
                        </div>
