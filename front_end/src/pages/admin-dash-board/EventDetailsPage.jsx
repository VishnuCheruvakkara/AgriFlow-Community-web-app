...
const EventDetailsPage = () => {
  ...
  if (!event) {
    return (
      <div className="min-h-screen w-full mb-4 flex items-center justify-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-3 mb-3">
                          <div className="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center border-2 border-white shadow-md">
                            <RiCommunityFill className="text-green-600 dark:text-green-400 w-6 h-6" />
                          </div>
                          <div>
                ...
                <div className="bg-zinc-50 dark:bg-zinc-700 rounded-lg shadow-sm border border-green-400">
                  ...
                  <div className="p-3">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                      {event.participations.map((participant, index) => (
                        <div key={index} className="flex items-center space-x-2 p-2 bg-white dark:bg-zinc-600 rounded-lg">
                          <img
          ...
          <div className="mt-6 py-4 border-t border-gray-200 dark:border-zinc-600">
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              ...
              <button className="bg-red-500 hover:bg-red-600 rounded-full text-white p-1 flex items-center space-x-2 transition-colors duration-200 shadow-md">
                ...
                <span className="text-sm pr-4 pl-2">Cancel Event</span>
              </button>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-gray-200 dark:border-zinc-600">
            <div className="flex flex-col sm:flex-row sm:justify-between text-xs text-gray-500 dark:text-zinc-100">
              <div className="flex items-center mb-1 sm:mb-0">
                ...
                <span>
                  <strong>Created:</strong> {new Date(event.created_at).toLocaleString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                    hour: '2-digit',
              ...
              <div className="flex items-center">
                ...
                <span>
                  <strong>Last Updated:</strong> {new Date(event.updated_at).toLocaleString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric',
                    hour: '2-digit',
