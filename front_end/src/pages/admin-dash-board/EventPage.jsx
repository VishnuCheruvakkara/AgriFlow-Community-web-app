                ...
                <tr className="hover:bg-gray-50 dark:hover:bg-zinc-900 transition">
                  ...
                  <td className="px-4 py-4 text-sm font-medium text-gray-900 dark:text-zinc-100">
                    <div className="flex items-center gap-2">
                      <FaCalendarAlt className="text-green-500 w-4 h-4" />
                      Annual Harvest Festival
                    </div>
                    <div className="text-xs text-gray-500 dark:text-zinc-400">Community Celebration Event</div>
                  </td>
                  <td className="px-4 py-4 text-sm text-gray-700 dark:text-zinc-300">Offline</td>
