    ...
    <>
            <div className="lg:w-10/12 space-y-4 mt-4 mb-11">
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
                ...
                <p className="text-gray-600">It's a great day for farming. Here's what's happening in your community.</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-4">
                ...
                <div className="mb-4 bg-gray-200 rounded-lg overflow-hidden">
                  <img src="/api/placeholder/600/400" alt="Post image" className="w-full object-cover" />
                </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">Organic Farmers Group</p>
                  ...
                  <li className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium">Sustainable Farming</p>
              ...
              <div className="bg-white rounded-lg shadow-sm p-4">
                ...
                <ul className="space-y-3">
                  <li className="border-l-4 border-green-500 pl-3 py-1">
                    <p className="font-semibold">Seed Distribution</p>
                  ...
                  <li className="border-l-4 border-blue-500 pl-3 py-1">
                    <p className="font-semibold">Irrigation Workshop</p>
                    <div className="flex items-center text-sm text-gray-600">
                      <BsCalendarEvent className="mr-1" />
