    ...
    return (
        <div className="container mx-auto py-4 max-w-full">
            ...
            <div className="bg-white rounded-b-lg shadow-sm p-6 mb-8 dark:bg-zinc-800">
                <p className="text-gray-600 dark:text-zinc-200 text-md">
                    Connect with fellow farmers, share knowledge, and grow together
                </p>

                {/* Tab navigation using NavLink for routing */}
                <div className="flex border-b dark:border-zinc-700 mt-4 overflow-x-auto text-xs sm:text-sm  ">
                    <NavLink
                        to="discover-communities"
                        className={({ isActive }) =>
                            `py-3 px-6 ripple-parent ripple-green hover:bg-green-200 dark:hover:bg-green-900 ${
                                isActive
