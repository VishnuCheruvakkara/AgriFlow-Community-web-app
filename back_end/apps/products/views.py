...
class UpdateProductAPIView(APIView):
    ...
    def patch(self, request, pk, *args, **kwargs):
        try:
            ...
            logger.error(f"Product with id {pk} not found or unauthorized access by user {request.user.id}")
...
class SoftDeleteProductView(APIView):
    ...
    def patch(self, request, pk):
        try:
            ...
            logger.exception(f"Error soft deleting product: {e}")
            return Response({'error': 'An error occurred while soft deleting the product.'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)  
...
class GetAllAvailableProducts(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching available products: {e}")
            return Response({"error": "An error occurred while fetching available products."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)    
...
class ProductDealMessageListView(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching product messages: {e}")
            return Response({"error": "An error occurred while fetching product messages."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)  
...
class GetSingleProductDetailsView(APIView):
    def get(self, request, product_id):
        try:
            ...
            return Response({"error": "An error occurred while fetching the product details."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class SellingProductDealsAPIView(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching selling product deals: {e}")
            return Response({"error": "An error occurred while fetching selling product deals."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR) 
...
class BuyingDealsView(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching buying deals: {e}")
            return Response({"error": "An error occurred while fetching buying deals."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class ToggleProductAvailabilityView(APIView):
    ...
    def patch(self, request, pk):
        try:
            ...
            logger.exception(f"Error toggling product availability: {e}")
            return Response({'error': 'An error occurred while updating product availability.'}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class ToggleWishlistAPIView(APIView):
    ...
    def post(self, request):
        try:
            ...
            logger.error(f"Product with id {product_id} not found for wishlist toggle.")
            return Response({"error": "Product not found"}, status=status.HTTP_404_NOT_FOUND)
        except Exception as e:
            logger.exception(f"Error toggling wishlist: {e}")
            return Response({"error": "An error occurred while toggling the wishlist."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class WishlistListAPIView(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching wishlist items: {e}")
            return Response({"error": "An error occurred while fetching wishlist items."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)   
...
class GetMyWishlistProductsAPIView(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching wishlist products: {e}")
            return Response({"error": "An error occurred while fetching wishlist products."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class GetAllProductsAdminSideView(APIView):
    ...
    def get(self, request):
        try:
            ...
            logger.exception(f"Error fetching products for admin: {e}")
...
class GetSingleProductAdminSideView(APIView):
    ...
    def get(self,request,product_id):
        try:
            ...
            logger.exception(f"Error fetching single product for admin: {e}")
            return Response({"error": "An error occurred while fetching the product."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class ToggleProductDeleteStatusView(APIView):
    ...
    def patch(self, request, pk):
        try:
            ...
            logger.exception(f"Error toggling product delete status: {e}")
            return Response({"error": "An error occurred while updating the product status."}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)            